...
Values('Benji', 'This is a test data note', 10.0, 56.9525126, 13.5898569, '2023-05-30', '2023-05-30', 'Daniel', '2023-05-30 02:55:02', (SELECT id FROM Counterparts WHERE id = 1), (SELECT id FROM Areas WHERE id = 3), (SELECT id FROM AssetTypes WHERE id = 1), (SELECT id FROM TechnologyTypes WHERE id = 1), (SELECT id FROM States WHERE id = 2))
